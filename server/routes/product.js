...
router.route('/admin/products').get(isAuntenticatedUser, authorizeRoles('admin'),getAdminProducts);   
router.route('/admin/product/:id').delete(isAuntenticatedUser, authorizeRoles('admin'),deleteProduct);      
